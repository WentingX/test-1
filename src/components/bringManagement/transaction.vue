<template>
	<!--撮合管理-交易成功-->
	<div class="matchsuccess">
		<el-row class="matchsuccess_top" v-if="tableData.length > 0" v-loading="loading">
		...
		<el-row class="matchsuccess_center">
			<el-row class="baogao">
				<span>企业审核报告</span>
			</el-row>
		...
		<el-row class="matchsuccess_buttom" v-if="tableData3.length > 0" v-loading="loading3">
			...
			<el-row class="zhuyaoxinxi2">
				...
				<div class="xinxi2">
					<div>附件：</div>
					<span v-for="i in tableData3[0].annexList" :key="Math.random()">
						<a :href="i.annex_url">{{i.annex_url.split('/')[i.annex_url.split('/').length-1]}}</a>
					</span>
				</div>
			</el-row>
		</el-row>
		<el-row class="matchsuccess_footer">
			<el-row class="baogao">
				<span>企业审核报告</span>
			</el-row>
		...
		<el-row class="matchsuccess_dc">
			...
			<el-table :data="tableData6" border style="width: 100%" v-loading="loading6">
				...
				<el-table-column prop="operating6" label="操作">
					<template slot-scope="scope">
						<el-button type="text" style="color: #58c443;">通过</el-button>
						<el-button type="text" style="color: #4d97ff;">查看</el-button>
					</template>
				</el-table-column>
			</el-table>
		</el-row>
		<el-row class="matchsuccess_wtgyy">
			<el-row class="baogao">
				<span>收益信息</span>
			</el-row>
			<el-row class="leibiao">
		...
		<div class="but2">
			<el-button class="matfailed">交易成功</el-button>				
		</div>
	</div>
</template>
<style>
...
.matchsuccess .el-table--enable-row-hover .el-table__row:nth-of-type(even){
    background:#f5f6fa;
}
.matchsuccess .el-table--enable-row-hover .el-table__body tr:hover>td{
  background: transparent;
}
.matchsuccess .matchsuccess_top{
	width: 100%;
}
.matchsuccess .matchsuccess_top .cuoheixinxi h4{
	color: #556191;
	border-left: 2px solid #88b7e0;
	padding-left: 20px;
}
.matchsuccess .matchsuccess_top p{
	color: #bcbcbc;
}
.matchsuccess .matchsuccess_top .el-table th{
	color:#FFFFFF;
	text-align:center;
	background: #4a4f63;
	border: none;
}
.matchsuccess .matchsuccess_top .el-table tr{
	text-align: center;
}
.matchsuccess .matchsuccess_top .zhuyaoxinxi{
	margin-top: 50px;
}
.matchsuccess .matchsuccess_buttom .zhuyaoxinxi2 .xinxi2 div,
.matchsuccess .matchsuccess_top .zhuyaoxinxi .xinxi div{
...
.matchsuccess .matchsuccess_buttom .zhuyaoxinxi2 .xinxi2 div span,
.matchsuccess .matchsuccess_top .zhuyaoxinxi .xinxi div span{
	width: 200px;
	margin-left: 50px;
	color: #000000;
}
.matchsuccess .matchsuccess_top .zhuyaoxinxi .xinxi span{
	margin-right: 20px;
}
.matchsuccess .matchsuccess_top .zhuyaoxinxi .xinxi .el-textarea__inner{
	width: 400px;
    border: none;
    border: 1px solid #999999;
    border-radius: 0;
}
.matchsuccess .matchsuccess_center{
	width: 100%;
}
.matchsuccess .matchsuccess_center .baogao{
	border-bottom: 2px solid #556191;
	padding-bottom: 20px;
	margin-bottom: 30px;
}
.matchsuccess .matchsuccess_center .baogao span{
	color: #556191;
	border-left: 2px solid #88b7e0;
	padding-left: 20px;
	margin-bottom: 24px;
}
.matchsuccess .matchsuccess_center .el-table th{
	color:#FFFFFF;
	text-align:center;
	background: #4a4f63;
	border: none;
}
.matchsuccess .matchsuccess_center .el-table tr{
	text-align: center;
}
.matchsuccess .matchsuccess_buttom{
	width: 100%;
	margin-top: 50px;
}
.matchsuccess .matchsuccess_buttom .el-table th{
	color:#FFFFFF;
	text-align:center;
	background: #4a4f63;
	border: none;
}
.matchsuccess .matchsuccess_buttom .el-table tr{
	text-align: center;
}
.matchsuccess .matchsuccess_buttom .zhuyaoxinxi2{
	margin-top: 50px;
}
.matchsuccess .matchsuccess_buttom .zhuyaoxinxi2 .xinxi2 span{
	margin-right: 20px;
}
.matchsuccess .matchsuccess_buttom .zhuyaoxinxi2 .xinxi2 .el-textarea__inner{
    width: 400px;
    border: none;
    border: 1px solid #999999;
    border-radius: 0;
}
.matchsuccess .matchsuccess_footer{
	width: 100%;
	margin-top: 60px;
}
.matchsuccess .matchsuccess_footer .baogao{
	border-bottom: 2px solid #556191;
	padding-bottom: 20px;
	margin-bottom: 30px;
}
.matchsuccess .matchsuccess_footer .baogao span{
	color: #556191;
	border-left: 2px solid #88b7e0;
	padding-left: 20px;
	margin-bottom: 24px;
}
.matchsuccess .matchsuccess_footer .el-table th{
	color:#FFFFFF;
	text-align:center;
	background: #4a4f63;
	border: none;
}
.matchsuccess .matchsuccess_footer .el-table tr{
	text-align: center;
}
.matchsuccess .matchsuccess_foo{
	width: 100%;
	margin-top: 60px;
}
.matchsuccess .matchsuccess_foo .baogao{
	border-bottom: 2px solid #556191;
	padding-bottom: 20px;
	margin-bottom: 30px;
}
.matchsuccess .matchsuccess_foo .baogao span{
	color: #556191;
	border-left: 2px solid #88b7e0;
	padding-left: 20px;
	margin-bottom: 24px;
}
.matchsuccess .matchsuccess_foo .el-table th{
	color:#FFFFFF;
	text-align:center;
	background: #4a4f63;
	border: none;
}
.matchsuccess .matchsuccess_foo .el-table tr{
	text-align: center;
}
.matchsuccess .matchsuccess_dc,
.matchsuccess_wtgyy
{
	width: 100%;
	margin-top: 60px;
}
.matchsuccess .matchsuccess_dc .baogao{
	border-bottom: 2px solid #556191;
	padding-bottom: 20px;
	margin-bottom: 30px;
}
.matchsuccess .matchsuccess_dc .baogao span{
	color: #556191;
	border-left: 2px solid #88b7e0;
	padding-left: 20px;
	margin-bottom: 24px;
}
.matchsuccess .matchsuccess_dc .el-table th{
	color:#FFFFFF;
	text-align:center;
	background: #4a4f63;
	border: none;
}
.matchsuccess .matchsuccess_dc .el-table tr{
	text-align: center;
}
.matchsuccess .matchsuccess_wtgyy .el-table{
	margin-bottom: 10px;
}
.matchsuccess .matchsuccess_wtgyy .baogao{
	border-bottom: 2px solid #556191;
	padding-bottom: 20px;
	margin-bottom: 30px;
}
.matchsuccess .matchsuccess_wtgyy .baogao span{
	color: #556191;
	border-left: 2px solid #88b7e0;
	padding-left: 20px;
	margin-bottom: 24px;
}
.matchsuccess .matchsuccess_wtgyy .el-table th{
	color:#FFFFFF;
	text-align:center;
	background: #4a4f63;
	border: none;
}
.matchsuccess .matchsuccess_wtgyy .el-table tr{
	text-align: center;
}
.matchsuccess .but2{
	width: 100%;
...
import API from '@/api/api.js'
  export default {
	...
	created(){
		...
		let a = "";
		_this.$data.bePublishId = "";
		let b = this.$route.params.id;
		API.tobematched10(_this.$route.params.id).then((res) =>{
			if(res.code == '200' && res.data){
				_this.$data.bePublishId = res.data.bePublishId;
				_this.$data.tableData = [res.data];
				API.tobematched11(_this.$data.bePublishId).then((res) =>{
					if(res.code == '200' && res.data){
				...
				_this.msga('error','获取数据失败')
			}
			_this.loading = false
		},
		(error) => {
			_this.msga('error','服务器错误')
			_this.loading = false
		});
	},
	methods: {
